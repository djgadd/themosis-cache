...
{
  /**
   * The default TTL if one isn't provided
   * @var int
   */
  ...
  **/
  ...
  {
    $uuid = uniqid(static::CACHE_CHECK_PREFIX, true);
  ...
  **/
  ...
  {
    $uuid = uniqid(static::CACHE_CHECK_PREFIX, true);
    $prefix = wp_cache_get($this->prefix, static::CACHE_GROUP_KEY, false, $uuid);
  ...
  **/
  public function setPrefix($prefix)
  {
    ...
    wp_cache_set($prefix, uniqid($prefix, true), static::CACHE_GROUP_KEY, 0);
  }
